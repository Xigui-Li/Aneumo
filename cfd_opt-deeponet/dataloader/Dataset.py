...
class CFDJobDataset(Dataset):
    def __init__(self, data_dir, case_ids, flow_rates, num_sample=1800):
        """
        ...
        for case_id in case_ids:
            ...
            for flow_rate in flow_rates:
                self.file_paths.extend(glob.glob(os.path.join(case_path, f"{flow_rate}*.job")))
    ...
    def __getitem__(self, idx):
        ...
        x_in_temp = np.array(stored_data["x_in_temp"])  
